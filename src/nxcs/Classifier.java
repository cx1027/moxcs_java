...
public class Classifier implements Serializable {
	...
	/* choose one of the vset as V
	 * 1. calculate Vset
	 *     calculate V', then calculate exp,avgDis
	 *      if Vset empty, add v into Vset, add exp and AvgDis
	 *      if v match one of V' in Vset, add exp and AvgDis
	 *      if v not match anyone of V' in Vset, add v into Vset, add exp and AvgDis
	 * 2. select one of the V' in Vset according it's avgDis and exp
	 * 
	 * Classifier 
	 * 1##1##1#01100000001#0000 = 0
	 * Theta: 0.00,
	 * Error: 0.00,
	 * Fitness: 0.58, 
	 * Prediction: 0.00, 
	 ...
	 * V:[-10.0, 10.0][-3.0, 1.0] 
	 * Vset:
	 * [Exp:3 AvgDis:0.0 V:[-3.0, 1.0] V:[-10.0, 10.0]]]
	 * [Exp:2 AvgDis:0.0 V:[-10.0, 10.0] V:[-3.0, 1.0]]]
	 * [Exp:4 AvgDis:1.4 V:[-8.0, 10.0] V:[-5.0, 1.0]]] 
	 * 
	 * 
	 * */
	public void setV(ArrayList<Qvector> v, ArrayList<Qvector> P) {
		...
		if (Vset.size() < 1) {
			...
			/*if v match?????????what is MinDistanceV? what is AvgDis*/
			//-->### see comments in MinDistanceV class
		...
		/* v doens't match any of Vset??? setAvgDis=distance */
		...
		/*select V according to lowest avgDis and exp>1*/
		chooseV();
	...
	private void chooseV() {
		...
		/*sorting Vset according to avgDistance*/
