...
public class maze4_result implements Environment {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			String[] discCalcMethods = { "MIN"};//, "MIN", "MAX", "CORE" };
...
//									"Hyper Volumn");
							logger.writeChartsAsSinglePlot(
									String.format(
											"log/maze4/charts/%s/%s/%s - %s - Trail %d - <CHART_TITLE>-hypervolumn-%d.png",
						...
						stepLogger.writeLogAndCSVFiles(
								String.format("log/maze4/csv/%s/%s/%s - %s - Trial %d - <TRIAL_NUM> - %d.csv", "MOXCS",
										"MAZE4", actionSelectionMethod, distCalcMethod, trailIndex, params.N),
								String.format("log/maze4/datadump/%s/%s - %s - Trail %d-<TIMESTEP_NUM> - %d.log", "MOXCS",
										actionSelectionMethod, distCalcMethod, trailIndex, params.N),
								traceWeights);
						stepLogger.writeChartsAsSinglePlot(
								String.format("log/maze4/charts/%s/%s/%s - %s - Trail %d - <CHART_TITLE> - %d.png", "MOXCS",
										"MAZE4", actionSelectionMethod, distCalcMethod, trailIndex, params.N),
					...
					crossTrialStats.writeLogAndCSVFiles(
							String.format("log/maze4/csv/%s/%s/%s - %s - Trial %s - <TRIAL_NUM>-HyperVolumn - %d.csv",
									"MOXCS", "MAZE4", actionSelectionMethod, distCalcMethod, "x", params.N),
							String.format("log/maze4/datadump/%s/%s - %s - Trail %s-<TIMESTEP_NUM> - hypervolumn - %d.log",
									"MOXCS", actionSelectionMethod, distCalcMethod, "x", params.N),
							"Hyper Volumn");
					crossTrialStats.writeChartsAsSinglePlot(
							String.format("log/maze4/charts/%s/%s/%s - %s - Trail %s - HyperVolumn - <CHART_TITLE> - %d.png",
									"MOXCS", "MAZE4", actionSelectionMethod, distCalcMethod, "x", params.N),
							String.format("%s on %s", "MOXCS", "MAZE4"), "performance", "Hyper Volumn");

					stepTrailsLogger.writeAverageChartsAsSinglePlot(
							String.format("log/maze4/charts/%s/%s/%s - %s - Trail %s - <CHART_TITLE> - %d.png", "MOXCS",
